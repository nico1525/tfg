...
namespace API.Controllers
{
    ...
    public class VehiculoController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutVehiculo(int id, VehiculoModifyDTO vehiculo)
        {
            ...
            {
                if (vehiculo.Matricula != null && vehiculo.Matricula != "") vehiculoChange.Matricula = vehiculo.Matricula;
            }
            if (vehiculo.Edificio != null && vehiculo.Edificio != "") vehiculoChange.Edificio = vehiculo.Edificio;
